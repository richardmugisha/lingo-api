...
const scenePrompt = (assets, structure, currentEp, currentAct, currentScenes, currentScene, currentWord) => `
    ...
    ground rules:
        ...
        - Don't spoon-feed the reader. Don't preach. Let the reader decide on the takeaway or how to feel.
